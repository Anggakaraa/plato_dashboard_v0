...
const ClinicianSidebarContent = (props) => {
  const { isClinicianAdmin } = useUser();
  ...
  return (
    <React.Fragment>
      <SimpleBar
        className="h-100 mt-15 clinician-sidebar"
        ref={ref}
        style={{
          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/stimulations" className="">
                ...
                <span>{props.t("Stimulations")}</span>
              </Link>
            </li>
...
ClinicianSidebarContent.propTypes = {
  location: PropTypes.object,
  t: PropTypes.any,
};

export default withRouter(withTranslation()(ClinicianSidebarContent));
