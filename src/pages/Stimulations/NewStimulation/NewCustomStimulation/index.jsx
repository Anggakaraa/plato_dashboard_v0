...
const NewCustomStimulation = (props) => {
  document.title = `${props.t("New Custom Stimulation")} | ${props.t(
    "Platoscience"
  )}`;
  ...
  const [cathode, setCathode] = useState(cathodes[0]);
...
NewCustomStimulation.propTypes = {
...
export default withRouter(withTranslation()(NewCustomStimulation));
